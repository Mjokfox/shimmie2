...
class SillyCookiesConfig extends ConfigGroup
{
    ...
    #[ConfigMeta("The title above", ConfigType::STRING, default: "Shimmie", ui_type: "longtext")]
    public const COOKIES_TITLE = "silly_cookies_title";
    #[ConfigMeta("The text to the right", ConfigType::STRING, default: "Shimmie", ui_type: "longtext")]
