...
use function MicroHTML\{BODY, emptyHTML, DIV, INPUT};
...
{
    // public function build_body(string $sitename, HTMLElement $main_links, ?string $main_text, ?string $contact_link, HTMLElement $num_comma, string $counter_text): HTMLElement
    // {
