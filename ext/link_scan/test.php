...
final class LinkScanTest extends ShimmiePHPUnitTestCase
{
    public function testScanPostView(): void
    {
        ...
        self::assertSame("/test/post/list/id%3D{$image_id_1}%2C{$image_id_2}/1", (string)$page->redirect);
    }
    ...
    public function testNotTriggered(): void
    {
        ...
        self::assertSame(PageMode::REDIRECT, $page->mode);
        self::assertSame("/test/post/list/Look%20at%20feb01bab5698a11dd87416724c7a89e3%2Ffoobar.jpg/1", (string)$page->redirect);
    }
}
