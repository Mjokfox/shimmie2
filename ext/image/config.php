...
final class ImageConfig extends ConfigGroup
{
    ...
    #[ConfigMeta("Fill post id gaps on upload", ConfigType::BOOL, default: false, advanced: true, help: "when using this, you probably want to change the default post sorting order to \"posted DESC\". If using postgres, you will need to alter the id column of the images table to GENERATED BY DEFAULT")]
    public const FILL_GAPS = 'fill_gaps';
}
